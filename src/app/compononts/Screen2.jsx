...
const MessageCard = ({
  ...
  return (
    <div className="flex justify-between items-center md:w-[470px] w-[100%] md:max-w-[100%] bg-[#156CAD] border-[#004B84] rounded-[10px]">
  ...
  return (
    <div className="bg-[#004B84] min-h-[600px]">
      ...
      <div className="flex justify-center items-center">
        <div className="grid md:grid-cols-2 gap-6 mt-6 grid-cols-1 md:px-0 px-5 md:pb-0 pb-5 mx-5">
